...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--cond_nc', type=int, default=0, help='# of condition channels')
        ...
        self.parser.add_argument('--pooling', type=str, default='max', help='upsample method max|mean')
