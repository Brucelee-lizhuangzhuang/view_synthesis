...
class UnsupervisedDepthModel(BaseModel):
    def name(self):
        return 'UnsupervisedDepthModel'
    ...
    def forward(self):
        ...
        self.forward_map = inverse_warp(self.real_A,self.depth, pose, self.intrinsics, self.intrinsics_inv)
    ...
    def backward_G(self):
        ...
        self.loss_G_L1 = self.criterionL1(self.fake_A[self.mask], self.real_A[self.mask]) * self.opt.lambda_A
        self.loss_G = self.loss_G_L1

        self.loss_G.backward(retain_graph=True)

        self.loss_val = self.criterionL1(self.depth[self.mask], self.real_C[self.mask])
    ...
    def get_current_visuals(self):
        ...
        return OrderedDict([('real_A', real_A), ('fake_A', fake_A), ('real_B', real_B), \
                            ('forward_map', forward_map), ('real_C', real_C),('depth', depth),('mask', mask),])
